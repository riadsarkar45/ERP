...
const GlanceModal = ({ glanceReport, setGlanceReport, handleGlanceReport }) => {
    ...
    const YARN_TABLE_HEADERS = [
        ...
        "REMARKS", "CAD CONSUMPTION", "PLANNED CUTTING QTY", "ACTUAL CUTTING QTY", "SHORT & EXCESS CUTTING",
        "SHORT/EXCESS %", "REMARKS", "CUTTING TO SEWING INPUT BALANCE", "PHYSICAL FOUND", "EXCESS QTY",
        "SWING INPUT QTY", "INPUT SHORT/EXCESS", "REMARKS", "OUTPUT QTY", "OUTPUT SHORT/EXCESS",
        "REMARKS", "FINISH INPUT QTY", "FINISH OUTPUT QTY", "SHORT EXCESS", "REMARKS",
        "PACKING INPUT QTY", "PACKING OUTPUT QTY", "SHIPPED QTY", "EXCESS SHORT", "PLANNED LEFTOVER",
        "PHYSICAL FOUND LEFTOVER", "%PHYSICAL FOUND LEFTOVER", "LEFT OVER SHORT EXCESS", "REMARKS",
    ];
