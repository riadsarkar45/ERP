...
const sampleData = [
    ...
    { id: 5, date: '2026-08-30', jobNumber: 'JOB-0998', styleNumber: 'STY-D02', color: 'Grey', dailyFinishingRcvd: 500, dailyFinishing: 495, remarks: '' },
    ...
    return (
        <div className="w-full rounded-lg border border-gray-200 bg-white shadow-sm">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 border-b border-gray-200 bg-white px-3 py-2">
                <h3 className="text-sm font-semibold text-slate-800">Daily Finishing Production</h3>
