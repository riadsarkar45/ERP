...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setToast({
          type: 'error',
          message: result.message || `${isLogin ? 'Login' : 'Registration'} failed`
        });
      }
    } catch (error) {
      setToast({
  ...
  const handleGoogleLogin = () => {
    ...
    setToast({
      type: 'info',
      message: 'Google login coming soon! Please use email login for now.'
    });
  };
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            {isLogin ? 'Sign in to your ERP account' : 'Join ERP System today'}
          </p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                className="appearance-none relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-primary-500 focus:border-primary-500 focus:z-10 sm:text-sm pr-10"
